...
def main():
    ...
    for i_iter, batch in enumerate(trainloader):
        ...
        #myi = images.reshape((6,3,512,512))
        
        if z==0:
            img1 = images[0]
            # img1 = img1.numpy() # TypeError: tensor or list of tensors expected, got <class 'numpy.ndarray'>
            save_image(img1, 'img1.png')
            my_img = Image.fromarray(np.array(img1))
            my_img.save('img1f.tif')
        ...
        sloss = np.array(loss.cpu().detach())
        #print(loss)
        ...
        if z % 98 == 0:
            ...
            if z<100:
                ...
                with open('loss.txt', 'a') as f:
                    ...
                    input_size = (h, w)
                    f.write('\n Validation RMSE: ')
                    f.write(str(eval(testloader, model, input_size)))
