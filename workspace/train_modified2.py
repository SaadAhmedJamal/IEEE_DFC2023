...
from networks.baseline_modified2 import Res_Deeplab
...
def main():
    ...
    for i_iter, batch in enumerate(trainloader):
        ...
        print(dsms.shape)
        #preds = model(images)
        sar_images = images[:,3:4,:,:]
        #print(sar_images.shape)
        images = torch.cat((images,sar_images,sar_images),dim =1)    
        #sar_images = torch.cat((sar_images,sar_images,sar_images),dim =1)
        #print(sar_images.shape)
        #sar_images = [sar_images,sar_images,sar_images]
